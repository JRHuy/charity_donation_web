          ...
          <div className="row">
            <div className="col-md-8">
              ...
              <div className="row">
                <div className="col-6 col-md-3">
                  ...
                  <h6 className="pt-1" id="bottom-menu">
                    Blog Cuộc Sống
                  </h6>
                </div>
            ...
            <div className="col-md-4">
              <div className="container" id="submenu-information">
                ...
                <p>
                  Hotline: <a id="contact">1900 5454 41</a> (1000 đ/phút)
                </p>
                <p>
                  Email: <a id="contact">hotro@momo.vn</a>
                </p>
                <p>
                  Tổng đài gọi ra: <a id="contact">028.7306.5555</a> -{" "}
                  <a id="contact">028.9999.5555</a>
                </p>
                <a href="">
                  <img
                    src="/apps/appmomo.png"
            ...
            <div className="row">
              <div className="col-sm-6">
                <div className="row">
                  ...
                  <div className="col-md-10">
                    ...
                    <p id="submenu-information">
                      Lầu 6, Toà nhà Phú Mỹ Hưng, số 8 Hoàng Văn Thái, khu phố
              ...
              <div className="col-sm-3">
                <a href="#" className="pe-2">
                  <img src="/social/Facebook.png" id="social"></img>
                </a>
                <a href="#" className="pe-2">
                  <img src="/social/LinkedIn.png" id="social"></img>
                </a>
                <a href="#" className="pe-2">
                  <img src="/social/youtube.png" id="social"></img>
                </a>
                <p id="submenu-information" className="pt-2">
              ...
              <div className="col-sm-3">
                ...
                <a href="#" className="pt-2">
                  <img src="/socongthuong.png" id="certification"></img>
                </a>
              </div>
            </div>
          </div>
